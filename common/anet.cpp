...
int anetNonBlock(char *err, int fd)        //将一个描述符设成非阻塞
{
    int flags;
...
int anetSetSendBuffer(char *err, int fd, int buffsize)         //设置发送缓冲区大小
{
...
int anetTcpKeepAlive(char *err, int fd)                         //设置keep-alive选项
{
    int yes = 1;
